...
tests:
    {{cc}} {{cflags}} {{mimalloc_cflags}} -I{{include_dir}} -c -o arena.o src/arena.c
    {{cc}} {{cflags}} -Wno-newline-eof {{mimalloc_cflags}} -I{{include_dir}} -o test src/tests.c src/rktest.c arena.o -lm {{mimalloc_ldflags}}
